...
import pg.eti.inz.settings.Option;
import pg.eti.inz.util.Constants;

/**
 * Klasa pomocnicza służąca do ułatwienia działań na bazie danych dla opcji.
 */
public class OptionsDatabaseProvider extends SQLiteOpenHelper {

    private static final Logger LOGGER = Logger.getLogger(OptionsDatabaseProvider.class.getName());
    private SQLiteDatabase database;

    public OptionsDatabaseProvider(Context context) {
